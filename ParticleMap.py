...
class ParticleMap:
    def __init__(self, device : spy.Device, num_particles, num_cells):
        ...
        self.vars = {
            "data":          device.create_buffer(element_count=num_particles, struct_size=4, usage=spy.BufferUsage.unordered_access|spy.BufferUsage.shader_resource),
            "sorted_data":   device.create_buffer(element_count=num_particles, struct_size=4, usage=spy.BufferUsage.unordered_access|spy.BufferUsage.shader_resource),
    ...
    def clear(self, command_encoder:spy.CommandEncoder):
        command_encoder.clear_buffer(self.vars["cell_offsets"])
